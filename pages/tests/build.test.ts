...
describe("build - static site generation", () => {
...
describe("build - robots.txt generation", () => {
  ...
  it("should use baseUrl from siteMetadata in robots.txt", async () => {
    ...
    expect(robots).toContain("Sitemap: https://custom-domain.com/sitemap.xml");
    expect(robots).not.toContain("example.com");
  });
});

describe("build - URL path to file path conversion", () => {
